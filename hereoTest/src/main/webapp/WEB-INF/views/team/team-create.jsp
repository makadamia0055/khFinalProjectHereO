				...
				<form action="" method="get" class="form-horizontal" enctype="multipart/form-data">
					<div class="form-group">
						<div class="team-selector">
							<label for="team">희망 팀 이름</label><br>
							<input type="text" class="col-lg-6" name="team_name" id="team_name" placeholder="최대 8자">
							<button class="btn btn-dark">팀명 중복 체크</button>
						</div>
					</div>
					<div class="form-group">
						<label for="team-local">지역</label>
							<select name="team-local" id="team-local">
					...
					<div class="form-group">
						...
						<input type="date" name="team-since" id="team-since" class="form-control  col-lg-8" placeholder="팀 창단일을 입력해주세요.">
					</div>
					
						<div class="form-group">
							<label for="team_img">팀 로고 이미지 파일</label><br>
							<input type="file" name="team_img" id="team_img">	
						</div>
						
						<div class="form-group">
						<label for="introduce">팀 슬로건</label><br>
						<input type="text" class="col-lg-12" name="team_slogan" placeholder="최대 25자 이내로 입력해주십시오.">
					</div>
